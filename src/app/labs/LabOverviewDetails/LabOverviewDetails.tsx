    ...
    <LayoutContainerSections title="Purebred Labrador Retriever Puppies" bgColor='brown'>
        <section className={styles.lab_overview}>
            <div className={styles.content}>
                <Image src={registedBusiness} className={styles.icon} alt=""/>
                <p> CKC registered business </p>
            </div>

            <div className={styles.content}>
            <Image src={vetChecked} className={styles.icon} alt=""/>
                <p> Veterinarian checked  </p>
            </div>

            <div className={styles.content}>
                <Image src={dogVaccine} className={styles.icon} alt=""/>
                <p> First set of shots/vaccines  </p>
            </div>

            <div className={styles.content}>
                <Image src={dogDewormed} className={styles.icon} alt=""/>
                <p> Dewormed </p>
            </div>

            <div className={styles.content}>
                <Image src={microchip} className={styles.icon} alt=""/>
                <p> Micro-chipped for identification  </p>
            </div>

            <div className={styles.content}>
                <Image src={dogHealth} className={styles.icon} alt=""/>
